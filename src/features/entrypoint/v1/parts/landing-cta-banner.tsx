...
export function LandingCtaBanner() {
  ...
  return (
    <section style={{ background: 'var(--paper)', padding: 'clamp(48px, 8vw, 80px) 20px clamp(64px, 10vw, 120px)' }}>
        ...
        >
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <motion.p
              ...
              custom={0.1}
              variants={fadeUp}
              style={{ fontSize: 'clamp(15px, 2vw, 18px)', color: 'rgba(255,255,255,0.7)', maxWidth: 440, margin: '0 auto 40px', lineHeight: 1.6 }}
            >
            ...
            >
              ...
              <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.55)', margin: 0 }}>No credit card required</p>
            </motion.div>
          </div>
        </div>
      </div>
