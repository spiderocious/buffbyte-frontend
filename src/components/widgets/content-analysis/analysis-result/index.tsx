...
const AnalysisResultsViewer: React.FC<AnalysisResultsViewerProps> = ({
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          <div className="text-center">
            ...
            <div className="text-2xl font-black text-slate-900 mb-1">
              {analysisData.sentiment?.confidence ? Math.round(analysisData.sentiment.confidence * 100) + '%' : 'N/A'}
            </div>
            <div className="text-sm text-slate-500 font-medium">Sentiment Confidence</div>
          </div>
        </motion.div>
        ...
        >
          <div className="text-center">
            ...
            <div className="text-2xl font-black text-slate-900 mb-1">
              {analysisData.virality?.score ? Math.round(analysisData.virality.score * 100) + '%' : 'N/A'}
            </div>
            <div className="text-sm text-slate-500 font-medium">Viral Potential</div>
          </div>
        </motion.div>
        ...
        >
          <div className="text-center">
            ...
            <div className="text-2xl font-black text-slate-900 mb-1">
              {analysisData.authenticity?.score ? Math.round(analysisData.authenticity.score * 100) + '%' : 'N/A'}
            </div>
            <div className="text-sm text-slate-500 font-medium">Authenticity</div>
          </div>
        </motion.div>
        ...
        >
          <div className="text-center">
            ...
            <div className="text-2xl font-black text-slate-900 mb-1">
              {analysisData.audience?.accessibility_score ? Math.round(analysisData.audience.accessibility_score * 100) + '%' : 'N/A'}
            </div>
            <div className="text-sm text-slate-500 font-medium">Accessibility</div>
          </div>
        </motion.div>
      </div>
      ...
      >
        <div className="flex items-center space-x-3 mb-6">
          ...
          <h4 className="font-bold text-slate-900 text-lg">Content Statistics</h4>
        </div>
        
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="text-center">
            <div className="text-2xl font-black text-slate-900 mb-1">{analysis.content.length}</div>
          ...
          <div className="text-center">
            <div className="text-2xl font-black text-slate-900 mb-1">
              {analysisData.quality?.readability_score ? Math.round(analysisData.quality.readability_score * 100) + '%' : 'N/A'}
            </div>
            <div className="text-sm text-slate-500 font-medium">Readability</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-black text-slate-900 mb-1">
              {analysisData.quality?.grammar_score ? Math.round(analysisData.quality.grammar_score * 100) + '%' : 'N/A'}
            </div>
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h4 className="font-bold text-slate-900 text-lg">Predicted Engagement</h4>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="text-center group">
                ...
                <div className="text-xl font-black text-slate-900 mb-1">
                  {analysisData.virality.predicted_engagement.likes.min} - {analysisData.virality.predicted_engagement.likes.max}
                </div>
              ...
              <div className="text-center group">
                ...
                <div className="text-xl font-black text-slate-900 mb-1">
                  {analysisData.virality.predicted_engagement.shares.min} - {analysisData.virality.predicted_engagement.shares.max}
                </div>
              ...
              <div className="text-center group">
                ...
                <div className="text-xl font-black text-slate-900 mb-1">
                  {analysisData.virality.predicted_engagement.comments.min} - {analysisData.virality.predicted_engagement.comments.max}
                </div>
                <div className="text-sm text-slate-500 font-medium">Comments</div>
              </div>
            </div>
          </div>
        </motion.div>
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center space-x-3 mb-6">
          ...
          <h3 className="font-bold text-slate-900 text-lg">Sentiment Analysis</h3>
        </div>
        
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="text-center">
            <div className={`text-4xl font-black mb-3 ${
              analysisData.sentiment?.score >= 0 ? 'text-emerald-600' : 'text-red-600'
            }`}>
              {analysisData.sentiment?.score?.toFixed(2) || 'N/A'}
            </div>
            <div className="text-sm text-slate-500 font-medium">Sentiment Score</div>
          </div>
          
          <div className="text-center">
            <div className={`text-2xl font-bold mb-3 capitalize ${
              analysisData.sentiment?.label === 'positive' ? 'text-emerald-600' :
              analysisData.sentiment?.label === 'negative' ? 'text-red-600' : 'text-slate-600'
            }`}>
              {analysisData.sentiment?.label || 'Neutral'}
            </div>
            <div className="text-sm text-slate-500 font-medium">Classification</div>
          </div>
      ...
      {analysisData.sentiment?.emotions && (
        ...
        >
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h4 className="font-bold text-slate-900 text-lg">Emotion Breakdown</h4>
          </div>
          
          <div className="space-y-4">
            {analysisData.sentiment.emotions.map((emotion: any, index: number) => (
              <motion.div 
                key={index} 
                  ...
                  <div className="w-full bg-slate-200 rounded-full h-3">
                    <motion.div 
                      className={`h-3 rounded-full ${
                        emotion.type === 'joy' || emotion.type === 'trust' || emotion.type === 'anticipation' ? 'bg-gradient-to-r from-emerald-400 to-emerald-600' :
                        emotion.type === 'anger' || emotion.type === 'fear' || emotion.type === 'sadness' ? 'bg-gradient-to-r from-red-400 to-red-600' :
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <h3 className="font-bold text-slate-900 text-lg">Virality Analysis</h3>
          </div>
        ...
        {analysisData.virality?.factors && (
          <div className="space-y-4">
            <h4 className="font-semibold text-slate-900 mb-4">Contributing Factors</h4>
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className={`px-4 py-2 rounded-full text-xs font-bold ml-4 ${
                    factor.impact === 'high' ? 'bg-gradient-to-r from-emerald-100 to-emerald-200 text-emerald-700 border border-emerald-300' :
                    factor.impact === 'medium' ? 'bg-gradient-to-r from-blue-100 to-blue-200 text-blue-700 border border-blue-300' :
    ...
    <div className="space-y-6">
      <div className="bg-white border border-slate-200 rounded-2xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h4 className="font-semibold text-slate-900 mb-3">Content Metrics</h4>
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold">
                  {analysisData.platform_analysis?.character_efficiency ? 
                    Math.round(analysisData.platform_analysis.character_efficiency * 100) + '%' : 'N/A'}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-600">Current Length</span>
                <span className="font-semibold">
                  {analysisData.platform_analysis?.optimal_length?.current || analysis.content.length}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-600">Recommended</span>
                <span className="font-semibold text-blue-600">
                  {analysisData.platform_analysis?.optimal_length?.recommended || 'N/A'}
                </span>
              </div>
            </div>
          </div>
            ...
            {analysisData.audience?.target_demographic && (
              <div className="space-y-2">
                <div className="text-sm">
                  <span className="font-medium">Age Group:</span> {analysisData.audience.target_demographic.age_group}
                </div>
                <div className="text-sm">
                  <span className="font-medium">Level:</span> {analysisData.audience.target_demographic.professional_level}
                </div>
                <div className="text-sm">
                  <span className="font-medium">Interests:</span>
                  <div className="flex flex-wrap gap-1 mt-1">
                    {analysisData.audience.target_demographic.interests?.map((interest: string, index: number) => (
        ...
        {analysisData.platform_analysis?.hashtag_optimization && (
          <div className="mt-6 pt-6 border-t border-slate-200">
            <h4 className="font-semibold text-slate-900 mb-4">Hashtag Strategy</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {analysisData.platform_analysis.hashtag_optimization.current_hashtags && (
                <div>
                  <div className="text-sm font-medium text-slate-700 mb-2">Current Hashtags:</div>
                  <div className="flex flex-wrap gap-2">
                    {analysisData.platform_analysis.hashtag_optimization.current_hashtags.map((tag: string, index: number) => (
              ...
              {analysisData.platform_analysis.hashtag_optimization.suggested_hashtags && (
                <div>
                  <div className="text-sm font-medium text-slate-700 mb-2">Suggested Hashtags:</div>
                  <div className="flex flex-wrap gap-2">
                    {analysisData.platform_analysis.hashtag_optimization.suggested_hashtags.slice(0, 6).map((tag: string, index: number) => (
                      <span key={index} className="px-2 py-1 bg-emerald-100 text-emerald-700 text-xs rounded-lg">
                        {tag}
                      </span>
                    ))}
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div className="text-center">
            <div className="text-3xl font-black text-slate-900 mb-2">
              {analysisData.brand?.voice_consistency ? Math.round(analysisData.brand.voice_consistency * 100) + '%' : 'N/A'}
            </div>
          ...
          <div className="text-center">
            <div className="text-xl font-bold text-slate-900 mb-2">
              {analysisData.brand?.formality_level ? Math.round(analysisData.brand.formality_level * 100) + '%' : 'N/A'}
            </div>
        ...
        {analysisData.brand?.brand_alignment && (
          <div className="bg-slate-50 rounded-xl p-4">
            <div className="flex items-center justify-between mb-3">
              <span className="font-semibold text-slate-900">Brand Alignment</span>
              <span className={`text-2xl font-bold ${
                analysisData.brand.brand_alignment.score >= 0.7 ? 'text-emerald-600' :
                analysisData.brand.brand_alignment.score >= 0.4 ? 'text-blue-600' : 'text-red-600'
              }`}>
            ...
            {analysisData.brand.brand_alignment.deviations && (
              <div>
                <div className="text-sm font-medium text-slate-700 mb-2">Areas for Improvement:</div>
                <div className="space-y-2">
                  {analysisData.brand.brand_alignment.deviations.map((deviation: string, index: number) => (
  ...
  const TimingContent = () => (
    <div className="space-y-6">
      {analysisData.timing?.optimal_post_times && (
        <div className="bg-white border border-slate-200 rounded-2xl p-6">
          <h3 className="font-bold text-slate-900 mb-4">Optimal Posting Times</h3>
          <div className="space-y-4">
            {analysisData.timing.optimal_post_times.map((time: any, index: number) => (
              <div key={index} className="bg-slate-50 rounded-xl p-4">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center space-x-3">
                    <FiClock className="w-5 h-5 text-blue-500" />
                    <div>
                      <div className="font-bold text-slate-900">{time.time}</div>
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-xs text-slate-500">Engagement Boost</div>
                  </div>
                </div>
      ...
      {analysisData.timing?.trending_alignment && (
        <div className="bg-slate-50 rounded-2xl p-6">
          ...
          <div className="space-y-4">
            {analysisData.timing.trending_alignment.map((trend: any, index: number) => (
              <div key={index} className="flex items-center justify-between">
                <span className="font-medium text-slate-700">{trend.trend}</span>
                <div className="flex items-center space-x-3">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6">
        ...
        <div className="text-center mb-6">
          <div className={`text-4xl font-black mb-2 capitalize ${
            analysisData.risk?.overall_risk === 'low' ? 'text-emerald-600' :
            analysisData.risk?.overall_risk === 'medium' ? 'text-orange-600' : 'text-red-600'
          }`}>
        ...
        {analysisData.risk?.compliance_check && (
          <div className="mt-6 pt-6 border-t border-slate-200">
            <h4 className="font-semibold text-slate-900 mb-3">Compliance Check</h4>
  ...
  const RecommendationsContent = () => (
    <div className="space-y-6">
      {analysisData.recommendations ? analysisData.recommendations.map((rec: any, index: number) => (
        <motion.div
          key={index}
          initial={{ opacity: 0, x: -20 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <div className="text-sm text-slate-500">
              Expected impact: <span className="font-semibold text-emerald-600">{rec.expected_impact}</span>
            </div>
          </div>
        </motion.div>
      )) : (
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 'sentiment': return <SentimentContent />;
      case 'virality': return <ViralityContent />;
      case 'brand': return <BrandContent />;
      case 'platform': return <PlatformContent />;
      case 'timing': return <TimingContent />;
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-slate-500 text-sm font-medium">
                  {new Date(analysis.createdAt).toLocaleDateString()} • {analysis.content.length} characters
                </p>
              </div>
            </div>
              ...
              {tabs.map((tab) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`relative z-10 ${isActive ? 'text-blue-600' : 'group-hover:text-blue-500'} transition-colors duration-200`}>
